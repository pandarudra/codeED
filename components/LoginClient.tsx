...
export default function LoginClient() {
  return (
    <div className="w-full min-h-screen flex items-center justify-center bg-transparent bg-opacity-90 relative">
      ...
      <div className="w-full max-w-md px-6 py-10 md:rounded-2xl rounded-none bg-zinc-900 shadow-xl space-y-6 text-center">
        {/* App Name */}
        <h1 className="text-4xl md:text-5xl d-font   text-white bg-clip-text animate-fade-in transition-transform duration-300 hover:scale-105 hover:drop-shadow-glow">
          duocode
        </h1>
